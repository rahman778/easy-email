...
export function MobileEmailPreview() {
   ...
   return (
      ...
      >
         <IframeComponent
            height={isResponsive ? "100%" : MOBILE_Height / (MOBILE_WIDTH / parseFloat(pageMaxWidth))}
            width="100%"
            style={{
               padding: 10,
               ...
               borderRadius: "25px",
               maxHeight: isResponsive ? MOBILE_Height : MOBILE_Height / (MOBILE_WIDTH / parseFloat(pageMaxWidth)),
               transform: isResponsive ? `scale(${responsiveScale})` : `scale(${MOBILE_WIDTH / parseFloat(pageMaxWidth)})`,
